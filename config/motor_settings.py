...
motor_config = {
    ...
    'safety_timeout': float(os.getenv('MOTOR_SAFETY_TIMEOUT', '1.5')),  # seconds - MUSI być > update_rate!
...
navigation_config = {
    ...
    'update_rate': float(os.getenv('NAV_UPDATE_RATE', '0.3')),  # seconds - częstotliwość control loop
}
